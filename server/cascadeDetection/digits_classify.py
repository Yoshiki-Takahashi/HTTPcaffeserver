...
if __name__ == '__main__':
    ...
    image = load_image('/home/user/digits/myProject/memberClassification/convertImages/iwasaki/img2609-4.png',256,256)

    digits_handler.set_image(image)
    predicted_label = digits_handler.run()[0][0]
